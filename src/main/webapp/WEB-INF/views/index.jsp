            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav" id='nky'>
                        ...
                        <li class="nav-item menu-item-has-children">
                            <a class="nav-link" data-toggle="collapse" href="#finance" aria-haspopup="true"
                                aria-expanded="false" aria-controls="bill">
                        ...
                        <li class="nav-item menu-item-has-children">
                            <a class="nav-link" data-toggle="collapse" href="#managers" aria-haspopup="true"
                                aria-expanded="false" aria-controls="bill">
                        ...
                        <li class="nav-item menu-item">
                            <a class="nav-link"  href="personal" target="myiframe"> <i class="menu-icon fa fa-user"></i>我的账户 </a>
                    </li>
                    <li class="nav-item menu-item">
                        <a class="nav-link"  href="mynews" target="myiframe"> <i class="menu-icon fa fa-cogs"></i>系统配置 </a>
                </li>
